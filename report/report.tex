...
\begin{figure}[H]
    ...
    \caption{Improvement in balanced accuracy over the Naive model on the \texttt{ionosphere} dataset across missingness mechanisms. Positive values indicate that label completion improves over direct fitting on the observed labels, while negative values indicate the opposite.}
